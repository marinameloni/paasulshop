...
<div class="flex flex-col justify-start mt-4">
  <div class="flex justify-between items-center">
    <div>
      <h2 class="text-xl font-bold font-poppins">Sanrio plushes</h2>
      <p class="text-sm text-gray-600 font-poppins">Enter the funny world of Sanrio Characters !</p>
    </div>
    <button
